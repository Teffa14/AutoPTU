...
describe("GitHub Pages career routing", () => {
  it("keeps the repository project-site prefix when navigating", () => {
  ...
  it("reads direct and fallback-served Pages URLs relative to the project-site base", () => {
    expect(careerPathFromLocation("/AutoPTU/career-game/new", "/AutoPTU/career-game/")).toBe("new");
    expect(careerPathFromLocation("/AutoPTU/career-game/run/demo", "/AutoPTU/career-game/")).toBe("run/demo");
