  ...
  return (
    <section className="career-home">
      ...
      <div className="career-entry-grid">
        <button className="career-entry-card normal" onClick={() => navigate("new")}>
        ...
        <button className="career-entry-card ranked" onClick={() => navigate("daily")}>
        ...
        <button className="career-entry-card leaderboard" onClick={() => navigate("leaderboard")}>
