...
const moveListEl = battleElements.moveListEl || document.getElementById("move-list");
const logEl = battleElements.logEl || document.getElementById("log");
const partyBarEl = battleElements.partyBarEl || document.getElementById("party-bar");
const turnOrderBarEl = battleElements.turnOrderBarEl || document.getElementById("turn-order-bar");
const roundInfoEl = battleElements.roundInfoEl || document.getElementById("round-info");
const terrainInfoEl = battleElements.terrainInfoEl || document.getElementById("terrain-info");
const weatherInfoEl = battleElements.weatherInfoEl || document.getElementById("weather-info");
const mapSeedEl = battleElements.mapSeedEl || document.getElementById("map-seed");
const sidebarRoundInfoEl = battleElements.sidebarRoundInfoEl || document.getElementById("sidebar-round-info");
const sidebarTerrainInfoEl = battleElements.sidebarTerrainInfoEl || document.getElementById("sidebar-terrain-info");
const sidebarWeatherInfoEl = battleElements.sidebarWeatherInfoEl || document.getElementById("sidebar-weather-info");
const jsStatusEl = document.getElementById("js-status");
const startButton = battleElements.startButton || document.getElementById("start-battle");
const endTurnButton = battleElements.endTurnButton || document.getElementById("end-turn");
...
const aiStepButton = battleElements.aiStepButton || document.getElementById("ai-step");
const aiAutoButton = battleElements.aiAutoButton || document.getElementById("ai-auto");
